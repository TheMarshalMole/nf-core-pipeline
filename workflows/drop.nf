...
workflow DROP {
    ...
    // // MODULE: MultiQC
    // //
    // workflow_summary    = WorkflowDrop.paramsSummaryMultiqc(workflow, summary_params)
    // ch_workflow_summary = Channel.value(workflow_summary)

    // methods_description    = WorkflowDrop.methodsDescriptionText(workflow, ch_multiqc_custom_methods_description)
